<?php
    ...
    $duplicate_user_query="select UPID from user_profile where email='$email'";
    ...
    if($rows_fetched>0){
        ...
        $user_registration_query="insert into user_profile(first_name,last_name,email,password,phone_number,dob,zip_code,city,state,address) values ('$first_name','$last_name','$email','$password','$phone_number','$dob','$zip_code','$city','$state','$address')";
        ...
        $_SESSION['UPID']=mysqli_insert_id($conn); 
