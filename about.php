...
<div id="container">
		...
		<main id="center" class="column">
         ...
         <br>
				 <h4>Mission</h4>
					<p style="text-indent:60px;">To provide a high quality footwear that suits the athletes style and to be one of the leading sports footwear apparel in the country.</p>
				<hr>
					<h4>Vision</h4>
						<p style="text-indent:60px;">The Shoe Store, the company that inspires, motivates, and gives determination to the sports enthusiast.</p>
