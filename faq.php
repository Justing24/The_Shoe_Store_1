...
<div id="container">
		...
		<main id="center" class="column">
			...
			<h3>Frequently Added Questions</h3>
         <br>
				 <h4>DO YOU SHIP?</h4>
					<p style="text-indent:60px;">Yes, we ship the products via UPS and Fedex.</p>
				<hr>
					<h4>DO YOU DELIVER?</h4>
						<p style="text-indent:60px;">No, We only offer Shipping.</p>
				<hr>
					<h4>WHEN WILL I GET MY ORDERS?</h4>
						<p style="text-indent:60px;">We wil ship your product in 2-3 days and It will take 4-6 days Nationwide.</p>
				<hr>
					<h4>HOW DO I PAY MY ORDERS?</h4>
					<p style="text-indent:60px;">Through Paypal or Credit Card.</p>
